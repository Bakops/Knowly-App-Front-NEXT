...
export default function HeaderComponent() {
  ...
  return (
    <div className="flex justify-around gap-9 align-middle m-6 h-height_header">
      <header className="flex flex-row justify-around items-center p-4 bg-gray-800 text-white rounded-full w-full md:w-[74.666667%] gap-2">
        ...
        <nav
          className={`w-full ml-20 bg-gray-800 flex-col items-center ${
            isMenuOpen ? "opacity-0" : "hidden"
          } md:flex md:flex-row md:w-auto`}
        >
          <ul className="flex flex-col md:flex-row md:gap-8">
            <li>
              <Link
                href="/"
                className="menu-link menu-link-active font-poppins font-bold text-[16px]"
              >
                Accueil
              </Link>
            </li>
            <li>
              <Link
                href="/cours"
                className="menu-link font-poppins font-bold text-[16px] "
              >
                Cours
              </Link>
            </li>
